...
class Post_EmpresasDto_ViewModel_Factory(private val repository: Post_EmpresasDto_Repository) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(Post_EmpresasDto_ViewModel::class.java)) {
            return Post_EmpresasDto_ViewModel(repository) as T
        }

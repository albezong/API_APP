...
class Post_UbicacionesDto_ViewModel_Factory(private val repository: Post_UbicacionesDto_Repository) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(Post_UbicacionesDto_ViewModel::class.java)) {
            return Post_UbicacionesDto_ViewModel(repository) as T
        }

...
class Post_EstatusDto_ViewModel_Factory(private val repository: Post_EstatusDto_Repository) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(Post_EstatusDto_ViewModel::class.java)) {
            return Post_EstatusDto_ViewModel(repository) as T
        }
